...
!(function (a) {
  ...
  return (
    ...
    (E._getItemTransformString = function (a, b) {
      return s
        ? 'translate3d(' + a.x + 'px, ' + a.y + 'px, 0) scale3d(' + b + ', ' + b + ', 1)'
    ...
    (E.prototype._getColumnSpan = function (a, b, c) {
      var d = a / b;
      return (
        Math.abs(Math.round(d) - d) < this.columnThreshold && (d = Math.round(d)),
    ...
    (E.prototype._whenCollectionDone = function (b, c, d) {
      function e(b) {
        b.target === b.currentTarget &&
          (a(b.target).off(c, e), f++, f === g && (h._removeTransitionReference(i), d.call(h)));
      }
      var f = 0,
        g = b.length,
        h = this,
    ...
    (E.prototype.shuffle = function (a, b) {
      this.enabled &&
        (a || (a = v), this._filter(a), this._updateItemCount(), this._shrink(), this.sort(b));
    }),
...
var ajaxurl = 'https://lmpixels.com/wp/leven-wp/wp-admin/admin-ajax.php';
...
var Formstone = (window.Formstone = (function (a, b, c) {
        ...
        (m.Plugins[c] = (function (c, d) {
          function f(b) {
            var e,
              ...
              k = a();
            for (
              b = a.extend(!0, {}, d.defaults || {}, i ? b : {}), f = 0, g = j.length;
              g > f;
              f++
            )
              if (((e = j.eq(f)), !h(e))) {
          ...
          function g() {
            d.functions.iterate.apply(
              this,
              [d.methods._destruct].concat(Array.prototype.slice.call(arguments, 1)),
            ),
          ...
          function k(c) {
            ...
            return e
              ? e.apply(b, Array.prototype.slice.call(arguments, 'object' === a.type(c) ? 0 : 1))
              : void 0;
          }
          function n(b) {
          ...
          return (
            ...
            d.widget &&
              ((m.Conflicts.fn[c] = a.fn[c]), (a.fn[s] = i), m.DontConflict || (a.fn[c] = a.fn[s])),
            (m.Conflicts[c] = a[c]),
            ...
            d.methods._raf &&
              (m.RAFHandlers.push({ namespace: c, priority: d.priority, callback: d.methods._raf }),
  ...
  return (
    ...
    a(function () {
      (m.$body = a('body')),
        n.resolve(),
        (m.support.nativeMatchMedia = m.support.matchMedia && !a('html').hasClass('no-matchmedia'));
    }),
...
!(function (a, b) {
  ...
  function c(a, c) {
    if (c) {
      (a.$target = this.find(a.target)),
        (a.$check = a.target ? a.$target : this),
        (a.callback = c),
        (a.styles = h(a.$check)),
        (a.timer = null);
  ...
  var j = b.Plugin('transition', {
      ...
      methods: { _construct: c, _destruct: d, resolve: f },
    }),
    k = j.events,
    l = j.functions,
    m = b.window;
...
!(function (a, b) {
  ...
  function e(b) {
    (b.youTubeGuid = 0),
      (b.$container = a('<div class="' + w.container + '"></div>').appendTo(this)),
      this.addClass([w.base, b.customClass].join(' '));
    var c = b.source;
    (b.source = null), g(b, c, !0), d();
  }
  function f(a) {
    a.$container.remove(),
      this.removeClass([w.base, a.customClass].join(' ')).off(x.namespace),
      d();
  }
  function g(b, c, d) {
    if (c !== b.source) {
  ...
  function h(a) {
    ...
    if (a.responsive) {
      ...
      for (var d in a.sources)
        a.sources.hasOwnProperty(d) &&
          (b.support.nativeMatchMedia
            ? a.sources[d].mq.matches && (c = a.sources[d].url)
            : a.sources[d].width < b.fallbackWidth && (c = a.sources[d].url));
    }
    return c;
  }
  function i(b, c, d, e) {
  ...
  function k(c, d, e) {
    ...
    if (
      (c.posterLoaded ||
        (c.source.poster || (c.source.poster = '//img.youtube.com/vi/' + c.videoId + '/0.jpg'),
        (c.posterLoaded = !0),
      ...
      if (
        (a("script[src*='youtube.com/iframe_api']").length ||
          a('head').append('<script src="//www.youtube.com/iframe_api"></script>'),
        C)
      ) {
...
jQuery(document).ready(function ($) {
  ...
  function columnStyles() {
    ...
    $('head').append(
      '<style data-styles="leven-theme-columns-css" type="text/css">' + custom_styles + '</style>',
    );
  }
  columnStyles();
