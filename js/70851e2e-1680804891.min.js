  ...
  jQuery.Event = function (src, props) {
    ...
    if (src && src.type) {
      ...
      this.isDefaultPrevented =
        src.defaultPrevented || (src.defaultPrevented === undefined && src.returnValue === !1)
          ? returnTrue
          : returnFalse;
  ...
  function getWidthOrHeight(elem, dimension, extra) {
    ...
    if (
      ((!support.boxSizingReliable() && isBorderBox) ||
        ...
        val === 'auto' ||
        (!parseFloat(val) && jQuery.css(elem, 'display', !1, styles) === 'inline')) &&
    ...
    jQuery.cssHooks[dimension] = {
      ...
      set: function (elem, value, extra) {
        var matches,
          ...
          isBorderBox =
            boxSizingNeeded && jQuery.css(elem, 'boxSizing', !1, styles) === 'border-box',
    ...
    function (state) {
      ...
      return this.each(function () {
        ...
        if (this.setAttribute) {
          this.setAttribute(
            'class',
            className || state === !1 ? '' : jQuery.data(this, '__className__') || '',
          );
        }
      });
    },
